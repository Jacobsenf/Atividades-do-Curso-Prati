...
### Todos os exercícios das listas podem ser executados de uma vez pois as variáveis são diferentes e os exercícios estão separados por divisórias para facilitar a execução e a visualização.
